...
// Repository builds a repository that points to the local testdata folder of the test
func Repository() files.Repository {
	return files.NewRepository("testdata/volatile")
}
