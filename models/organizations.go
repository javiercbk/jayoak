...
var (
	...
	organizationColumnsWithoutDefault = []string{"name", "created_at", "updated_at"}
...
func (o *Organization) Instruments(mods ...qm.QueryMod) instrumentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"instruments\".\"organization_id\"=?", o.ID),
	)
...
func (o *Organization) Sounds(mods ...qm.QueryMod) soundQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"sounds\".\"organization_id\"=?", o.ID),
	)
...
func (organizationL) LoadInstruments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrganization interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`instruments`), qm.WhereIn(`organization_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (organizationL) LoadSounds(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrganization interface{}, mods queries.Applicator) error {
	var slice []*Organization
	var object *Organization
	...
	query := NewQuery(qm.From(`sounds`), qm.WhereIn(`organization_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (organizationL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeOrganization interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`users`), qm.WhereIn(`organization_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
